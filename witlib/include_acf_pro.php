<?php
    ...
    /**
     * Filename: force_acf_install.php
     * Description:
     * Author: ryan
     */
    ...
    if ( !class_exists('acf') ) { // if ACF Pro plugin does not currently exist
        ...
        function cysp_acf_settings_path( $path ) {
            $path = plugin_dir_path( __FILE__ ) . 'plugins/advanced-custom-fields-pro/';
            return $path;
        }
        ...
        function cysp_acf_settings_dir( $path ) {
            $dir = plugin_dir_url( __FILE__ ) . 'plugins/advanced-custom-fields-pro/';
            return $dir;
        }
        /** End: Customize ACF path */
...
//        add_filter('acf/settings/show_admin', '__return_false');
        ...
        /** Start: Include ACF */
        include_once( plugin_dir_path( __FILE__ ) . 'plugins/advanced-custom-fields-pro/acf.php' );
        /** End: Include ACF */
...
//        add_filter('acf/settings/load_json', 'cysp_acf_json_load_point');
        ...
        function cysp_stop_acf_update_notifications( $value ) {
            unset( $value->response[ plugin_dir_path( __FILE__ ) . 'plugins/advanced-custom-fields-pro/acf.php' ] );
            return $value;
        }
